...
const form = useForm({
    ...
    meta_title_format: props.settings.meta_title_format ?? '%page_title% | %site_name%',
            ...
            <div class="space-y-6 lg:col-span-2">
                ...
                <Card>
                    ...
                    <CardContent class="space-y-4">
                        ...
                        <div class="space-y-1.5">
                            ...
                            />
                            <p class="text-xs text-muted-foreground">A short phrase that describes your site.</p>
                        </div>
                        ...
                        <div class="space-y-1.5">
                            ...
                            />
                            <p v-if="form.errors.admin_email" class="text-sm text-destructive">{{ form.errors.admin_email }}</p>
                            <p class="text-xs text-muted-foreground">Used for system notifications.</p>
                        </div>
                        ...
                        <div class="space-y-1.5">
                            ...
                            />
                            <p class="text-xs text-muted-foreground">Relative path or full URL to your favicon image.</p>
                        </div>
                    </CardContent>
                </Card>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Default SEO settings applied across your site.</CardDescription>
                    </CardHeader>
                    <CardContent class="space-y-4">
                        <div class="space-y-1.5">
                            ...
                            <p class="text-xs text-muted-foreground">
                                Available tokens: <code class="rounded bg-muted px-1 text-xs">%page_title%</code>,
                                <code class="rounded bg-muted px-1 text-xs">%site_name%</code>
                            </p>
                        </div>
                        ...
                        <div class="space-y-1.5">
                            ...
                            <Textarea
                                ...
                                rows="3"
                            />
                            <p class="text-xs text-muted-foreground">Used on pages without a custom meta description. Aim for 150–160 characters.</p>
                        </div>
                    </CardContent>
                </Card>
            ...
            <div class="space-y-6">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Control what visitors see on the front page.</CardDescription>
                    </CardHeader>
                    <CardContent class="space-y-4">
                        <div class="space-y-1.5">
                            ...
                            <Select
                                ...
                                @update:model-value="(val: string) => (form.homepage_id = val === '__none__' ? null : val)"
                            >
                                <SelectTrigger id="homepage_id">
                                    <SelectValue placeholder="— default (latest posts) —" />
                                </SelectTrigger>
                                <SelectContent>
                                    <SelectItem value="__none__">— default (latest posts) —</SelectItem>
                                    <SelectItem
