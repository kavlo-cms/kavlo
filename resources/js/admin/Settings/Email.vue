...
function save() {
    const data: Record<string, string | null> = {
        ...
        mail_test_template_id:
            form.mail_test_template_id === '__plain__'
                ? null
                : form.mail_test_template_id,
    };
            ...
            <div class="space-y-6 lg:col-span-2">
                ...
                <Card>
                    ...
                    <CardContent class="space-y-4">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <p
                                v-if="hasPassword && !passwordChanged"
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription
                            >The sender name and address used for outgoing
                            mail.</CardDescription
                        >
                    </CardHeader>
                    <CardContent class="space-y-4">
                        <div class="space-y-1.5">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription
                            >Select reusable builder-backed templates for
                            outgoing system mail.</CardDescription
                        >
                    </CardHeader>
                    <CardContent class="space-y-4">
                        <div class="space-y-1.5">
                            <Label for="mail_test_template_id"
                                >Test Email Template</Label
                            >
                            <Select v-model="form.mail_test_template_id">
                                <SelectTrigger id="mail_test_template_id">
                                    <SelectValue
                                        placeholder="Use plain-text fallback"
                                    />
                                </SelectTrigger>
                                <SelectContent>
                                    <SelectItem value="__plain__"
                                        >Use plain-text fallback</SelectItem
                                    >
                                    <SelectItem
                            ...
                            <p class="text-xs text-muted-foreground">
                                Used by the test email action below. Form
                                notifications choose their own template inside
                                each form.
                            </p>
                        </div>
            ...
            <div class="space-y-6">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Send a test email to the administration address to
                            verify your settings.
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <dl
                            class="mb-4 space-y-1 text-sm text-muted-foreground"
                        >
                            <div class="flex justify-between gap-3">
                                <dt>Queue connection</dt>
                                <dd class="font-medium text-foreground">
                                    {{ props.delivery.connection }}
                                </dd>
                            </div>
                            <div class="flex justify-between gap-3">
                                <dt>Queue name</dt>
                                <dd class="font-medium text-foreground">
                                    {{ props.delivery.queue }}
                                </dd>
                            </div>
                            <div class="flex justify-between gap-3">
                                <dt>Delivery mode</dt>
                            ...
                            <div
                                v-if="props.delivery.failed_jobs !== null"
                                class="flex justify-between gap-3"
                            >
                                <dt>Failed jobs</dt>
                                <dd class="font-medium text-foreground">
                                    {{ props.delivery.failed_jobs }}
                                </dd>
                            </div>
                        </dl>
